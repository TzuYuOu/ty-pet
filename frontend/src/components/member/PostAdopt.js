          ...
          <div className="col-md-8 mb-2">
            <div className="card">
              <div className="card-header card-header-lg bg-danger rounded-top">
                <h4 className="text-center font-weight-medium text-white">送養資訊</h4>
              </div>
              <div className="card-body pt-5">
                ...
                <div className="row">
                  ...
                  <div className="form-group col-md-4">
                    <label htmlFor="name">是否結紮</label>
                    <select className="form-control border-info" name="animal_ligation" id="animal_ligation">
                      <option value>請選擇</option>
                ...
                <div className="row">
                  <div className="form-group col-md-12">
                    <label htmlFor="name">領養要求</label>
                    <div className="row">
                      <div className="form-group col-lg-3 col-xs-6">
                        <select className="form-control border-warning" name="follow_agree" id="follow_agree" required>
                          <option value>請選擇</option>
                          <option value="需要同意後續追蹤">需要同意後續追蹤</option>
                          <option value="不需要同意後續追蹤">不需要同意後續追蹤</option>
                        </select>
                      </div>
                      <div className="form-group col-lg-3 col-xs-6">
                        <select className="form-control border-danger" name="age_agree" id="age_agree" required>
                          <option value>請選擇</option>
                          <option value="需要年滿20歲">需要年滿20歲</option>
                          <option value="不需要年滿20歲">不需要年滿20歲</option>
                        </select>
                      </div>
                      <div className="form-group col-lg-3 col-xs-6">
                        <select className="form-control border-primary" name="family_agree" id="family_agree" required>
                          <option value>請選擇</option>
                          <option value="需要家人同意">需要家人同意</option>
                          <option value="不需要家人同意">不需要家人同意</option>
                        </select>
                      </div>
                      <div className="form-group col-lg-3 col-xs-6">
                        <select className="form-control border-secondary" name="need_agree" id="need_agree" required>
                          <option value>請選擇</option>
                          <option value="需要簽署愛心認養切結書">需要簽署愛心認養切結書</option>
                          <option value="不需要簽署愛心認養切結書">不需要簽署愛心認養切結書</option>
                        </select>
                      </div>
                    </div>
                  </div>
